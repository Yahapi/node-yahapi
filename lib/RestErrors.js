...
function BadRequestError() {
    RestError.call(this, 400, 'bad-request-error', 'Request body is invalid');
}
...
function UnauthorizedError() {
    RestError.call(this, 401, 'unauthorized-error', 'Missing or invalid user credentials');
}
...
function ForbiddenError() {
    RestError.call(this, 403, 'forbidden-error', 'Invalid priviliges');
}
...
function AssertError(message) {
    RestError.call(this, 500, 'assert-error', message);
}
