...
* @return {Links} This Links to allow method chaining.
*/
Links.prototype.paginate = function(defaultLimit, total) {
...
* @returns {Links} This Links to allow method chaining.
*/
Links.prototype.setParam = function(parameter, value) {
...
*/
Links.prototype.getParam = function(field) {
...
*/
Links.prototype.build = function() {
    var result = {
        self: {
            href: this._pathname
        }
