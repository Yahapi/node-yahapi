 ...
 * @param {int} total
 */
function Collection(requestUrl, items, offset, limit, defaultLimit, total) {
    this.url = requestUrl;
    this.items = items;
    this.offset = offset;
    this.limit = limit;
 ...
 */
Collection.prototype.representation = function (representationFunction) {
    var representation = {
        items: [],
        meta: {
            total: this.total,
        ...
        links: new Links(this.url).paginate(this.defaultLimit, this.total).build()
    };
